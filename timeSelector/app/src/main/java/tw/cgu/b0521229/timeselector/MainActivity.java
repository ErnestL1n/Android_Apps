package tw.cgu.b0521229.timeselector;
...
public class MainActivity extends AppCompatActivity
    ...
    public void onDateSet(DatePicker v, int y, int m, int d) {
        txDate.setText("您設定的日期為\n" + y + "年" + (m+1) + "月" + d+"日");  // 將選定日期顯示在螢幕上
        txDate.setTextColor(Color.rgb(0,0,255));
    }

    @Override
    public void onTimeSet(TimePicker v, int h, int m) {
        txTime.setText("您設定的時間為\n" + h + "點" + m+"分");    // 將選定的時間顯示在螢幕上
        txTime.setTextColor(Color.rgb(0,0,255));
    }
}